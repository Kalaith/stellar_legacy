...
export const CulturalEvolutionComponent: React.FC<CulturalEvolutionProps> = ({
            ...
            <div key={change.id} className="border-l-2 border-terminal-secondary pl-4 relative">
              ...
              <div className="mb-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {change.isPermanent && (
                      <TerminalText
                        variant="success"
                        className="text-xs border border-terminal-success px-1"
                      >
                        [PERMANENT]
                      </TerminalText>
                    )}
                ...
                <div className="mt-2">
                  <TerminalText variant="dim" className="text-xs">
                    CULTURAL IMPACT:{' '}
                    <span className={getDeviationColor(change.impact)}>
                      {change.impact > 0 ? '+' : ''}
                      {change.impact}%
                    </span>
                  </TerminalText>
      ...
      <TerminalWindow title="TREND PREDICTIONS" statusLine="PROBABILITY ANALYSIS">
        <div className="space-y-3">
          <div className="border border-terminal-border p-3">
            ...
            <TerminalText variant="secondary" className="text-sm">
              LIKELIHOOD:{' '}
              <TerminalText variant="warning" className="inline">
                75%
              </TerminalText>{' '}
          ...
          <div className="border border-terminal-border p-3">
            ...
            <TerminalText variant="secondary" className="text-sm">
              LIKELIHOOD:{' '}
              <TerminalText variant="primary" className="inline">
                60%
              </TerminalText>{' '}
          ...
          <div className="border border-terminal-border p-3">
            ...
            <TerminalText variant="secondary" className="text-sm">
              LIKELIHOOD:{' '}
              <TerminalText variant="error" className="inline">
                45%
              </TerminalText>{' '}
  ...
  const renderAnalysisTab = (evolution: CulturalEvolution) => {
    const totalImpact = evolution.majorChanges.reduce(
      ...
      <div className="space-y-4">
        <TerminalWindow title="CULTURAL GUIDANCE" statusLine="POLICY MANAGEMENT">
          ...
          <div className="grid grid-cols-2 gap-3">
            <TerminalButton
              onClick={() =>
                onCulturalAction('preserve_traditions', {
                  legacy: evolution.legacy,
                })
              }
              variant="primary"
            >
            ...
            <TerminalButton
              onClick={() =>
                onCulturalAction('encourage_innovation', {
                  legacy: evolution.legacy,
                })
              }
              variant="success"
            ...
            <TerminalButton
              onClick={() =>
                onCulturalAction('cultural_festival', {
                  legacy: evolution.legacy,
                })
              }
              variant="primary"
            ...
            <TerminalButton
              onClick={() =>
                onCulturalAction('generational_dialogue', {
                  legacy: evolution.legacy,
                })
              }
              variant="warning"
        ...
        <TerminalWindow title="STABILIZATION ACTIONS" statusLine="CULTURAL CONTROL">
          <div className="space-y-3">
            <div
              ...
              onClick={() =>
                onCulturalAction('cultural_census', {
                  legacy: evolution.legacy,
                })
              }
            >
            ...
            <div
              className="border border-terminal-border p-3 cursor-pointer hover:border-terminal-primary transition-colors"
              onClick={() =>
                onCulturalAction('cultural_education', {
                  legacy: evolution.legacy,
                })
              }
            >
            ...
            <div
              className="border border-terminal-border p-3 cursor-pointer hover:border-terminal-primary transition-colors"
              onClick={() =>
                onCulturalAction('cultural_reform', {
                  legacy: evolution.legacy,
                })
              }
            >
          ...
          >
            ...
            <div className="space-y-3">
              <div
                ...
                onClick={() =>
                  onCulturalAction('cultural_restoration', {
                    legacy: evolution.legacy,
                  })
                }
              >
              ...
              <div
                ...
                onClick={() =>
                  onCulturalAction('accept_evolution', {
                    legacy: evolution.legacy,
                  })
                }
              >
