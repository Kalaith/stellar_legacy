  ...
  return (
    ...
    >
      ...
      >
        ...
        {member.isHeir && (
          <span
            className={`${uiConstants.COLORS.BG_WARNING} ${uiConstants.COLORS.TEXT_PRIMARY} text-xs px-2 py-1 rounded`}
          >
            Heir
          </span>
        )}
        ...
        {skillEntries.map(([skill, level]) => (
          <div key={skill} className="flex items-center justify-between">
            ...
            <div className="flex-1 mx-2">
              <div
                className="w-full bg-gray-800 border border-gray-600 h-2"
      ...
      <p className={`${uiConstants.COLORS.TEXT_MUTED} text-xs leading-relaxed`}>
        {member.background}
      </p>
    </div>
  );
