  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
      ...
      <div className={`${uiConstants.CARDS.BACKGROUND} ${uiConstants.CARDS.BASE} ${uiConstants.SPACING.CARD_PADDING} ${uiConstants.CARDS.BORDER}`}>
        <h3 className={`text-lg font-semibold ${uiConstants.SPACING.SECTION_MARGIN_SM} ${uiConstants.COLORS.TEXT_PRIMARY}`}>Galactic Market</h3>
        <div className="space-y-4">
          {marketItems.map((item) => (
            <div key={item.key} className={`flex items-center justify-between p-4 ${uiConstants.COLORS.BG_SECONDARY} rounded-lg`}>
              <div className="flex items-center space-x-3">
                <span className="text-2xl">{item.icon}</span>
                <div>
                  <div className={`font-medium ${uiConstants.COLORS.TEXT_PRIMARY}`}>{item.name}</div>
      ...
      {/* Available Contracts */}
      <div className={`${uiConstants.CARDS.BACKGROUND} ${uiConstants.CARDS.BASE} ${uiConstants.SPACING.CARD_PADDING} ${uiConstants.CARDS.BORDER}`}>
        <h3 className={`text-lg font-semibold ${uiConstants.SPACING.SECTION_MARGIN_SM} ${uiConstants.COLORS.TEXT_PRIMARY}`}>Available Contracts</h3>
        <div className="space-y-4">
          <div className={`p-4 ${uiConstants.COLORS.BG_SECONDARY} rounded-lg`}>
            ...
            <button className={`w-full px-3 py-2 rounded text-sm font-medium ${uiConstants.COLORS.BG_SUCCESS} hover:bg-teal-700 ${uiConstants.COLORS.TEXT_PRIMARY} transition-colors`}>
              Accept Contract
            </button>
          </div>
          ...
          <div className={`p-4 ${uiConstants.COLORS.BG_SECONDARY} rounded-lg`}>
            <h4 className={`font-medium mb-2 ${uiConstants.COLORS.TEXT_PRIMARY}`}>Research Mission</h4>
            <p className={`text-sm ${uiConstants.COLORS.TEXT_SECONDARY} mb-3`}>
