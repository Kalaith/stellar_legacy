  ...
  return (
    <header className="terminal-header-main" style={{ padding: '0.5rem 1rem' }}>
      ...
      <div className="terminal-status-bar" style={{ marginBottom: '0.25rem' }}>
        ...
        >
          <div className="terminal-resource-item">
            │ CREDITS:{' '}
            <TerminalText variant={getStatusColor(resources.credits, 5000)}>
              {formatNumber(resources.credits)}
            </TerminalText>{' '}
            │ ENERGY:{' '}
            <TerminalText variant={getStatusColor(resources.energy, 1000)}>
              {formatNumber(resources.energy)}
            </TerminalText>{' '}
            │ MINERAL:{' '}
            <TerminalText variant={getStatusColor(resources.minerals, 500)}>
              {formatNumber(resources.minerals)}
            </TerminalText>{' '}
            │ FOOD:{' '}
            <TerminalText variant={getStatusColor(resources.food, 800)}>
              {formatNumber(resources.food)}
            </TerminalText>{' '}
            │ INFLUENCE:{' '}
            <TerminalText variant={getStatusColor(resources.influence, 200)}>
      ...
      >
        ...
        <div className="terminal-text dim">COORD: [CLASSIFIED]</div>
        <div className="terminal-text success">STATUS: OPERATIONAL</div>
      </div>
    </header>
  );
};
